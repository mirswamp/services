...
use Env qw($TEST_CRITIC $TEST_VERBOSE $TEST_POD);
...
# Figure our where this script is being run from and look
# for the perlcriticrc file in *that* directory.
my $dir = dirname(abs_path("$PROGRAM_NAME"));
...
if ( not $TEST_CRITIC ) {
	...
	my $rcfile = File::Spec->catfile( $dir, 'perlcriticrc' );
